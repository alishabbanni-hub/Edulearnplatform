...
export function CoursesGrid({ category, onCourseSelect }: CoursesGridProps) {
  const allCourses: Course[] = [
    ...
    {
      id: 1,
      title: 'Self-Directed Learning: Students as Drivers of Their Own Learning',
    ...
    {
      id: 2,
      title: 'From Passive Learning to Deep Engagement: Project-Based and Phenomenon-Based Learning in Action',
